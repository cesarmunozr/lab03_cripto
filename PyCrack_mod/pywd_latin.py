...
def MakeMIC(pwd, ssid, A, B, data, wpa = False):
    ...
    pmk = pbkdf2_hmac('sha1', pwd.encode('latin-1'), ssid.encode('ascii'), 4096, 32)
...
if __name__ == "__main__":
    ...
    wordlist_path = '/home/cmunoz/Desktop/Cripto/Lab3/rockyou_mod.dic'
    # Leer el diccionario
    S = read_passwords(wordlist_path)
